...
namespace NuSocial.Core.ViewModel
{
    public abstract partial class ViewModelBase : ObservableValidator, IQueryAttributable
    {
        ...
        private IStringLocalizer<NuSocialResource>? _localizer;
        ...
        private ViewModelBase(IStringLocalizer<NuSocialResource> localizer)
        {
        ...
        public IStringLocalizer<NuSocialResource> L
        {
            get
            {
                _localizer ??= Ioc.Default.GetRequiredService<IStringLocalizer<NuSocialResource>>();
                return _localizer;
            }
            set
            {
